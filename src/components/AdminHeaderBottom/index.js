...
import { getAdmin, logout } from '../AuthAdmin/authAdminSlice';
...
const AdminHeaderBottom = () => {
    ...
    const handleLogOut = () => {
        dispatch(logout());
        return navigate('auth-admin');
    };

    return (
        <div className="header-admin">
            <div className="header-content">
                <nav className="navbar-admin navbar-expand">
                        ...
                        <ul className="navbar-nav header-right">
                            <li className="nav-item d-flex align-items-center">
                                <div className="input-group search-area">
                                    ...
                                    <span className="input-group-text">
                                        <Link>
                                            <i className="bx bx-search input-group-text-icon"></i>
                            ...
                            <li
                                ...
                                onClick={() =>
                                    setOpenDropdown({
                                        ...openDropdown,
                                        notification_dropdown: !openDropdown.notification_dropdown,
                                    })
                                }
                            >
                                <Link className="nav-link">
                                ...
                                {openDropdown.notification_dropdown && (
                                    <div className="dropdown-menu">
                                        <div className="widget-media dlab-scroll">
                                                    ...
                                                    <div className="timeline-panel">
                                                        <div className="media me-2">
                                                            <Image
                                                                alt="image"
                                                                width="50"
                                                                src={images.avatar_img_1}
                                                            ></Image>
                                                        </div>
                                                        <div className="media-body">
                                                            <h6>Dr sultads Send you Photo</h6>
                                        ...
                                        <Link className="all-notification">
                            ...
                            {authAdminState.isAuthenticated && (
                                <li className="nav-item dropdown  header-profile" style={{ marginRight: '20px' }}>
                                    <Link
                                        className="nav-link"
                                        role="button"
                                        ...
                                        onClick={() =>
                                            setOpenDropdown({
                                                ...openDropdown,
                                                profile: !openDropdown.profile,
                                            })
                                        }
                                    >
                                        <img src={images.userImg} width="56" alt="" />
                                    </Link>
                                    {openDropdown.profile && (
                                        <div className="dropdown-menu">
                                            <div className="dropdown-menu-header">
                                                Hello,{authAdminState.admin.name}
                                            </div>
                                            <Link href="./app-profile.html" className="dropdown-item ai-icon">
                                                <svg
                                                    id="icon-user1"
                                                    xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <Link href="./email-inbox.html" className="dropdown-item ai-icon">
                                                <svg
                                                    id="icon-inbox"
                                                    xmlns="http://www.w3.org/2000/svg"
