            ...
            try {
                if (selectTypeBus !== null) {
                    const create_bus = async () => {
                        ...
                        if (res.status === 200) {
                            Notify.success('Create Bus Success', {
                                zindex: `999999`,
                                useIcon: false,
                                cssAnimationStyle: 'from-right',
                                cssAnimationDuration: 500,
                    ...
                    Confirm.show('Create Bus', 'Are you sure to create this Bus?', 'Yes', 'No', () => {
                        create_bus();
                    });
                } else {
