...
import { BL_Ma } from '~/Data/RouteInformation';
            ...
            <tbody className="table-body">
                <tr>
                    ...
                    <td className="sub-title">
                        <span>{BL_Ma[0].data.location}</span>
                        <p className="desc">{BL_Ma[0].data.address}</p>
                    </td>
                </tr>
                <tr>
                    <td className="time-td">
                    ...
                    <td className="sub-title">
                        <span>{BL_Ma[1].data.location}</span>
                        <p className="desc">{BL_Ma[1].data.address}</p>
                    </td>
                </tr>
            </tbody>
        </table>
